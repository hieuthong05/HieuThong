        ...
        <div class="product-info">
            ...
            <div class="product-infomation">
                ...
                <div class="product-actions-center">
                    <form action="${pageContext.request.contextPath}/CartController" method="post" class="add-to-cart-form">
                        <input type="hidden" name="action" value="addToCart"/>
                        <input type="hidden" name="productId" value="<%= product.getProductId() %>"/>
                        <input type="hidden" name="unitPrice" value="<%= product.getPrice() %>"/>
                        <button type="submit" class="btn-cart"><i class="fas fa-shopping-cart"></i></button>
                    </form>

                    <form action="${pageContext.request.contextPath}/CartController" method="post" class="buy-now-form">
                        <input type="hidden" name="action" value="addToCart">
                        <input type="hidden" name="productId" value="<%= product.getProductId() %>">
                        <input type="hidden" name="unitPrice" value="<%= product.getPrice() %>">
                ...
                <div class="review-container">
                    ...
                    %>
                        <div class="card">
                            ...
                            <div class="infos">
                                <p class="date-time"><%= u.getCreatedAt() %></p>
