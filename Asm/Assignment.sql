...
EXEC sp_rename 'Laptop','Product';
select* from Product
-- Laptop
UPDATE Product SET imageUrl = 'images/MacBook_Air_M2_13.jpg' WHERE productId = 1;
UPDATE Product SET imageUrl = 'images/Dell_Inspiron_15_3520.jpg' WHERE productId = 2;
UPDATE Product SET imageUrl = 'images/HP_Pavilion_14.jpg' WHERE productId = 3;
UPDATE Product SET imageUrl = 'images/Asus_ROG_Strix_G16.jpg' WHERE productId = 4;
UPDATE Product SET imageUrl = 'images/Lenovo_IdeaPad_3.jpg' WHERE productId = 5;

-- Smartphone
UPDATE Product SET imageUrl = 'images/iPhone_15_Pro_Max_256GB.jpg' WHERE productId = 6;
UPDATE Product SET imageUrl = 'images/Samsung_Galaxy_S24_Ultra_256GB.jpg' WHERE productId = 7;
UPDATE Product SET imageUrl = 'images/Xiaomi_Redmi_Note_13_Pro.jpg' WHERE productId = 8;
UPDATE Product SET imageUrl = 'images/Sony_Xperia_1_V.jpg' WHERE productId = 9;
UPDATE Product SET imageUrl = 'images/Samsung_Galaxy_A55.jpg' WHERE productId = 10;

-- Tablet
UPDATE Product SET imageUrl = 'images/iPad_Air_5_M1_64GB_WiFi.jpg' WHERE productId = 11;
UPDATE Product SET imageUrl = 'images/Xiaomi_Pad_6_8GB_256GB.jpg' WHERE productId = 12;
UPDATE Product SET imageUrl = 'images/Samsung_Galaxy_Tab_S9_FE.jpg' WHERE productId = 13;

-- Smartwatch
UPDATE Product SET imageUrl = 'images/Apple_Watch_Series_9_41mm.jpg' WHERE productId = 14;
UPDATE Product SET imageUrl = 'images/Galaxy_Watch6_40mm.jpg' WHERE productId = 15;

-- Desktop PC
UPDATE Product SET imageUrl = 'images/Dell_Vostro_3888_MT.jpg' WHERE productId = 16;
